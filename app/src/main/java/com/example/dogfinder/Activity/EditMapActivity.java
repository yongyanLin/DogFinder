...
public class EditMapActivity extends BaseActivity implements OnMapReadyCallback {
    GoogleMap map;
    ...
    public void setCurrentLocation() {
        ...
        Geocoder geocoder = new Geocoder(EditMapActivity.this, Locale.getDefault());
        try{
    ...
    public void sendBackData(){
        ...
        if(bundle != null){
            ...
            Intent intent = new Intent(EditMapActivity.this, EditFormActivity.class);
            ...
            bundle1.putSerializable("dog1",bundle.getSerializable("dog1"));
